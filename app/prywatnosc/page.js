  ...
  return (
    <main className="page" style={{ maxWidth: 780 }}>
      ...
      <div className="card knowledge">
        ...
        <h2>Podpowiedzi z internetu i średnie ceny</h2>
        <p>Funkcja „Uzupełnij z internetu” wysyła do zewnętrznego dostawcy usługi AI wyłącznie nazwę odmiany i producenta (bez danych osobowych). Ceny, które wpisujesz przy odmianach, tworzą średnią cenę widoczną dopiero od 3 zgłoszeń i nigdy nie ujawniają pojedynczych wpisów.</p>
        <h2>Kto to widzi</h2>
